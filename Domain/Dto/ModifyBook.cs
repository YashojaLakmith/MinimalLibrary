...
{
    public record ModifyBook(string BookId, string BookName, string[] AuthorNames, string ISBN = "", string BookImageURL = "#") : IValidatable
    {
        public void Validate()
        {
            if (string.IsNullOrEmpty(BookId)) throw new ValidationFailedException("Id cannot be null or empty.");
